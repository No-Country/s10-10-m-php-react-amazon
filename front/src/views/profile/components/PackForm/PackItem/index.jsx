...
const PackItem = ({ item, handleRemovePack, handleMinus, setPacks, packs }) => {
  ...
  return (
    <div className="w-full overflow-y-auto">
      ...
      <p className={buttonDetail ? "text-textButton font-sizeTextButton my-2 cursor-pointer text-colorPrimary font-weightTitle" : "custom-textButton my-2"} onClick={handleOpenDetail}>Gestionar pack</p>
      {openDetail && (
