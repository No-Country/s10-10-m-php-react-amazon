    ...
    <div>
      ...
      <div>
        <p className="my-3 font-bold text-mainColor">
          Explora ofertas locales y rescata alimentos. Regístrate y compra a
          precios bajos. ¡Salva alimentos, marca la diferencia!
        </p>
        <div>
          <button
            className="rounded-full bg-mainColor text-white w-widthMainBtn h-heightMainBtn"
            style={{ fontSize: "12px" }}
          >
