    ...
    <div>
      ...
      <div className="flex justify-between my-8">
        <Link to="/auth/user/login">
          <Button
            className="rounded-full normal-case bg-mainColor p-0 text-white w-widthMainBtn h-heightMainBtn"
            style={{ fontSize: "12px" }}
          >
        ...
        <Button
          className="rounded-full normal-case p-0 bg-white text-mainColor border border-black w-widthMainBtn h-heightMainBtn"
          style={{ fontSize: "12px" }}
        >
