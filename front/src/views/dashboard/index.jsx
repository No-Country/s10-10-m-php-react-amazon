  ...
  return (
    <div className="p-3">
      <div className="p-5 flex items-center justify-center">
        ...
        <FontAwesomeIcon icon={faSliders} className="rotate-90 text-2xl m-2 cursor-pointer" onClick={handleFilter}/>
        <DialogFilter open={showFilter} handleOpen={handleFilter} />
