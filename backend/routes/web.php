...
Route::get('/login-google', function () {
    ...
    ->header('Access-Control-Allow-Origin', 'https://s10-10-m-php-react-amazon-production.up.railway.app, https://s10-10-m-php-react.onrender.com, http://localhost:5173');
});
